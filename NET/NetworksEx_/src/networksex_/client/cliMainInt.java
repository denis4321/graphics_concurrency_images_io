...
public class cliMainInt extends JFrame implements ConnectionListener {
    ...
    public cliMainInt() {
        try {
            ...
            jbInit();
            AddrField.setText("192.168.1.45");
            setState(false);
    ...
    public void connect() {
        try {
            ...
            Socket s = new Socket(AddrField.getText().trim(), 3334);
    ...
    public void jButton1_actionPerformed(ActionEvent e) {
        if (!this.nowIsModel2) {
            ...
            this.jButton1.setText("Перейти в магазин");
            this.jButton2.setEnabled(false);
            nowIsModel2 = true;
        } else {
            this.jButton1.setText("Корзина");
            this.jButton2.setEnabled(true);
            this.jList1.setModel(model);
            nowIsModel2 = false;
        }
