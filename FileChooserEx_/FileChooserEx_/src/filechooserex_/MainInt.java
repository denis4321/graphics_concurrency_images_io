...
public class MainInt extends JFrame {
    ...
    public MainInt() {
        try {
            ...
            //Загружаем иконку
            Image img = Toolkit.getDefaultToolkit().getImage(getClass().getResource("/icons/1201.jpg")/*"1201.jpg"*/).getScaledInstance(50, 50, Image.SCALE_SMOOTH);
