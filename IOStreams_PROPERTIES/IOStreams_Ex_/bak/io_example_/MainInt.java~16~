...
public class MainInt extends JFrame {
    ...
    public void save() {
        try {
            String result = (String)JOptionPane.showInputDialog(this, "Выберите тип сохранения", "Сохранение", JOptionPane.QUESTION_MESSAGE, null, new String[]{"Data", "Serialize"}, null);
