...
public class biMainInt extends JFrame {
    ...
    JButton MirrorBut = new JButton();
    JButton RotateBut = new JButton();
    ...
    private void jbInit() throws Exception {
        ...
        MirrorBut.setText("Зеркало");
        MirrorBut.addActionListener(new biMainInt_MirrorBut_actionAdapter(this));
        RotateBut.setText("Поворот");
        RotateBut.addActionListener(new biMainInt_RotateBut_actionAdapter(this));
        ...
        jToolBar1.add(MirrorBut);
        jToolBar1.add(RotateBut);
    }
            ...
            public BufferedImage filter(BufferedImage src, BufferedImage dest) {
                ...
                for (int y = 0; y < src.getHeight(); y++) {
                    for (int x = src.getWidth() - 1; x >= 0; x--) {
                        dest.setRGB(dest.getWidth()-1-x, y, src.getRGB(x, y));
                    }
                }
                return dest;
            }
...
class biMainInt_RotateBut_actionAdapter implements ActionListener {
    private biMainInt adaptee;
    biMainInt_RotateBut_actionAdapter(biMainInt adaptee) {
...
class biMainInt_MirrorBut_actionAdapter implements ActionListener {
    private biMainInt adaptee;
    biMainInt_MirrorBut_actionAdapter(biMainInt adaptee) {
        this.adaptee = adaptee;
    }
